function checkC() {
	...
	//if (coord.indexOf(",") != -1 ) {
		...
		c1 = c1.trim();
		c2 = c2.trim();
		if (!isNaN(c1) && !isNaN(c2) && c1>-90 && c1<90 && c2>-180 && c2<180) {
			sys = "WGS84";
		...
		if (c1>6100000 && c1<7700000 && c2>1180000 && c2<1890000) {
			sys = "RT90";
			interpreted = c1+"N, "+c2+"E";
...
function RT90toWGS84(RT90) {
	...
	return [rnorth.toPrecision(6) , reast.toPrecision(6)];
}
...
function Sweref99TMtoWGS84(Sweref99TM) {
	...
	return [wnorth.toPrecision(6), weast.toPrecision(6)];
}
