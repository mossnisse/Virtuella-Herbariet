...
<?php
    ...
    $desc = " <h3> 2. Exportera nytt data från FileMaker till en .csv fil </h3>
       ...
       `AccessionNo`, `Day`, `Month`, `Year`, `Genus`, `Species`, `SspVarForm`, `HybridName`, `collector`,
        ...
        `Long_sec`, `long_dir`, `LastModified` , `LINREG`, Type status, Basionym, Type Auktor. <br />
    ...
    replacepage("file med LINREG", "do_replaceLINREG.php", $desc, "LD", "<option value=\"utf8\">UTF-8 Unicode</option>", "<option value=\"\r\n\">\r\n - DOS/Windows</option>", $con2);
?>
