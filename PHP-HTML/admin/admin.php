...
<body>
    <div>
        <a href="replace.php">updatera databasen LD, UMU...</a> <br />
        <a href="replaceLINREG.php">updatera databasen LD med LINREG...</a> <br />
        <a href="replaceImage.php">updatera databasen LD med Image...</a> <br />
        <a href="replaceUPS.php">updatera databasen UPS...</a> <br />
        ...
        <a href="insertRevOHN.php">sätt in revisions fil OHN</a> <p />
        <a href="delete.php">ta bort fil från databasen...</p> <br />
        <a href="empty_cache.php">töm cache för crossbrowser och listorna i standard search</a> <br />
        <a href="id_links.php">räkna om länkar</a> <br />
        <a href="redoCoordinates.php">räkna om koordinaterna..</a> <p />
        <a href="stat.php">användar statistik</a> <br />
