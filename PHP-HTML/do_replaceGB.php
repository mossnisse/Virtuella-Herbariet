...
if (isUpdating2()) {
    ...
    if ($a) {
        ...
        $query = "LOAD DATA INFILE '$uploadfile' INTO TABLE specimens CHARACTER SET $char_set FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '$line_endings'
            ...
            /*
            `AccessionNo`, `Day`, `Month`, `Year`, `Genus`, `Species`, `SspVarForm`, `HybridName`, `CollectorOriginal`, `Collectornumber`, `Comments`, `Continent`, `Country`,
            `Province`, `District`, `Locality`, `Cultivated`,
            `AltitudeLow`, `AltitudeHigh`, `Original_name`, `Original_text`, `Notes`, `Exsiccata_name`, `Exsiccata_no`, `RUBIN`, `RiketsN`,
            `RiketsO`, `LatitudeDegree`, `LatitudeMinute`, `LatitudeSecond`, `LatitudeDirection`, `LongitudeDegree`, `LongitudeMinute`, `LongitudeSecond`, `LongitudeDirection`, `Modified`,
            `LINREG`, `Sweref_N`, `Sweref_O`, `UTM`, `TypeStatus`, `Basionym`, `Auctor`, `Image1`, `Image2`, `Image3`, `Image4`*/
